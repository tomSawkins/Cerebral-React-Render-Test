declare module "cerebral-view-react" {
    ...
    export function connect<TPropsIn, TModel>(path: (props: TPropsIn) => any, view: (props: TModel) => any): any;
    ...
    export function connect<TModel>(path: any, view: (props: TModel) => any): any
}
